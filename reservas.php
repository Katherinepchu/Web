...
<html lang="es">
	...
	<div class="contenedor">
		...
		<label class="fontawesome-align-justify" for="menu-bar"></label>
    	 	...
    	 	<div class="contenedor">
				<form name="form" method="post" action="insertargaleria.php" enctype="multipart/form-data">

	
		<form action="">
        <h2>RESERVAS DE EVENTO</h2>
			<tr>

<td><SELECT name="tipoevento" placeholder="Tipo Evento"style=" width:410; height:40px;">
<option value="">-Tipos de Evento-</option>

<?php  
             
              $query= "SELECT * FROM tipoeventos "; 
                 $resultado = mysql_query($query);
               
              while($lista = mysql_fetch_array($resultado)){ 
          
               
               echo " <option value='".$lista["idtipoevento"]."'>".$lista["tipoeventos"]."</option>"; 
...
<input name="cbipeliculas" type="checkbox" />Películas
<br />
<input type="text" name="FechaEvento" placeholder="Fecha de Evento">

        <input type="text" name="nombre" placeholder="Nombre">
		<input type="text" name="Apellidos" placeholder="Apellidos completo">
		<input type="text" name="Fechanaci" placeholder="Fecha de Nacimiento">


        <input type="text" name="correo" placeholder="gmail.com">
